...
class Lab(Base):
    ...
    kg_schemas: Mapped[list["KgSchema"]] = relationship("KgSchema", back_populates="lab", cascade="all, delete-orphan")
    neo4j_connections: Mapped[list["Neo4jConnection"]] = relationship("Neo4jConnection", back_populates="lab", cascade="all, delete-orphan")
